...
Feature: Create student
  ...
  Scenario: 1. Create student as a team member and verify status code 403
    ...
    When user sends POST request to "/api/students/student" with following information:
      ...
      | Lesly      | McDonald  | leviathanbcqonline@email.com | 1111     | student-team-member | VA              | 15           | Online_Hackers |
  ...
  When user logs in with "leviathanbcqonline@email.com" email and "1111" password
